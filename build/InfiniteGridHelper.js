...
// Modified by: [erjbroek]
export class InfiniteGridHelper extends THREE.Mesh {
    constructor(size1 = 10, size2 = 100, color = 'white', distance = 8000, axes = 'xz') {
      ...
      `,
        ...
        void main() {
          float d = 1.0 - min(distance(cameraPosition.${planeAxes}, worldPosition.${planeAxes}) / uDistance * 4.0, 1.0);
